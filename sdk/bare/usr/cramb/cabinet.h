...
#define CAB_INV6_PHA_ADC_GAIN (-0.510765)
#define CAB_INV6_PHB_ADC_GAIN (-0.510356)
#define CAB_INV6_PHC_ADC_GAIN (-0.51092)

//ADC current sensor offsets
#define CAB_INV6_PHA_ADC_OFFSET (-0.0222095)
#define CAB_INV6_PHB_ADC_OFFSET (-0.00136184)
#define CAB_INV6_PHC_ADC_OFFSET (-0.00649711)
